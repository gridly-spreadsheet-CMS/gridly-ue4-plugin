...
TSharedPtr<FSlateStyleSet> FGridlyStyle::StyleInstance = nullptr;

void FGridlyStyle::Initialize()
{
...
FName FGridlyStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("GridlyStyle"));
	return StyleSetName;
}
...
TSharedRef<FSlateStyleSet> FGridlyStyle::Create()
{
...
void FGridlyStyle::ReloadTextures()
{
...
const ISlateStyle& FGridlyStyle::Get()
{
